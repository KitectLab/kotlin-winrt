...
class JvmWinRtUInt64ArgDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtUInt64ArgDelegate::class.java,
                "queryInterface",
        ...
        private val invokeStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtUInt64ArgDelegate::class.java,
                "invoke",
                MethodType.methodType(Int::class.javaPrimitiveType, MemorySegment::class.java, Long::class.javaPrimitiveType),
            ),
            FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_LONG),
            libraryArena,
        )

        fun create(iid: Guid, invoke: (ULong) -> HResult): JvmWinRtUInt64ArgDelegate {
            ...
            return JvmWinRtUInt64ArgDelegate(arena, instance)
        }
        ...
        @JvmStatic
        private fun invoke(thisPointer: MemorySegment, arg: Long): Int {
            val state = states[thisPointer.address()] ?: return KnownHResults.E_POINTER.value
            return state.invoke(arg.toULong()).value
        }
