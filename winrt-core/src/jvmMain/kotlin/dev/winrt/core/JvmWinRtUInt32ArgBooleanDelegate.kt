...
class JvmWinRtUInt32ArgBooleanDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtUInt32ArgBooleanDelegate::class.java,
                "queryInterface",
        ...
        private val invokeStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtUInt32ArgBooleanDelegate::class.java,
                "invoke",
                MethodType.methodType(Int::class.javaPrimitiveType, MemorySegment::class.java, Int::class.javaPrimitiveType, MemorySegment::class.java),
            ),
            FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT, ValueLayout.ADDRESS),
            libraryArena,
        )

        fun create(iid: Guid, invoke: (UInt) -> Boolean): JvmWinRtUInt32ArgBooleanDelegate {
            ...
            return JvmWinRtUInt32ArgBooleanDelegate(arena, instance)
        }
        ...
        @JvmStatic
        private fun invoke(thisPointer: MemorySegment, arg: Int, result: MemorySegment): Int {
            val state = states[thisPointer.address()] ?: return KnownHResults.E_POINTER.value
            result.reinterpret(ValueLayout.JAVA_INT.byteSize().toLong()).set(
                ValueLayout.JAVA_INT,
                0,
                if (state.invoke(arg.toUInt())) 1 else 0,
            )
