...
class JvmWinRtInt32ArgBooleanDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtInt32ArgBooleanDelegate::class.java,
                "queryInterface",
        ...
        fun create(iid: Guid, invoke: (Int) -> Boolean): JvmWinRtInt32ArgBooleanDelegate {
            ...
            return JvmWinRtInt32ArgBooleanDelegate(arena, instance)
        }
