...
class JvmWinRtInt64ArgDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtInt64ArgDelegate::class.java,
                "queryInterface",
        ...
        fun create(iid: Guid, invoke: (Long) -> HResult): JvmWinRtInt64ArgDelegate {
            ...
            return JvmWinRtInt64ArgDelegate(arena, instance)
        }
