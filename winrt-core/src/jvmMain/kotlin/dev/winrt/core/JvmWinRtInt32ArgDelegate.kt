...
class JvmWinRtInt32ArgDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtInt32ArgDelegate::class.java,
                "queryInterface",
        ...
        fun create(iid: Guid, invoke: (Int) -> HResult): JvmWinRtInt32ArgDelegate {
            ...
            return JvmWinRtInt32ArgDelegate(arena, instance)
        }
