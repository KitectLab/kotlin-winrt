...
class JvmWinRtStringArgDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtStringArgDelegate::class.java,
                "queryInterface",
        ...
        private val invokeStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtStringArgDelegate::class.java,
                "invoke",
                MethodType.methodType(Int::class.javaPrimitiveType, MemorySegment::class.java, MemorySegment::class.java),
            ),
            FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.ADDRESS),
            libraryArena,
        )

        fun create(iid: Guid, invoke: (String) -> HResult): JvmWinRtStringArgDelegate {
            ...
            return JvmWinRtStringArgDelegate(arena, instance)
        }
        ...
        @JvmStatic
        private fun invoke(thisPointer: MemorySegment, arg: MemorySegment): Int {
            val state = states[thisPointer.address()] ?: return KnownHResults.E_POINTER.value
            val value = PlatformHStringBridge.toKotlinString(HString(arg.address()))
            return state.invoke(value).value
        }
