...
class JvmWinRtFloat32ArgDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtFloat32ArgDelegate::class.java,
                "queryInterface",
        ...
        private val invokeStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtFloat32ArgDelegate::class.java,
                "invoke",
                MethodType.methodType(Int::class.javaPrimitiveType, MemorySegment::class.java, Float::class.javaPrimitiveType),
            ),
            FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_FLOAT),
            libraryArena,
        )

        fun create(iid: Guid, invoke: (Float) -> HResult): JvmWinRtFloat32ArgDelegate {
            ...
            return JvmWinRtFloat32ArgDelegate(arena, instance)
        }
        ...
        @JvmStatic
        private fun invoke(thisPointer: MemorySegment, arg: Float): Int {
            val state = states[thisPointer.address()] ?: return KnownHResults.E_POINTER.value
