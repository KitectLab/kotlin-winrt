...
class JvmWinRtNoArgDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtNoArgDelegate::class.java,
                "queryInterface",
        ...
        fun create(iid: Guid, invoke: () -> HResult = { HResult(0) }): JvmWinRtNoArgDelegate {
            ...
            return JvmWinRtNoArgDelegate(arena, instance)
        }
        ...
        @JvmStatic
        private fun invoke(thisPointer: MemorySegment): Int {
            val state = states[thisPointer.address()] ?: return KnownHResults.E_POINTER.value
            return state.invoke().value
        }
