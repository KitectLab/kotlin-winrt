...
class JvmWinRtObjectArgDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtObjectArgDelegate::class.java,
                "queryInterface",
        ...
        fun create(
            iid: Guid,
            invoke: (ComPtr) -> HResult = { HResult(0) },
        ): JvmWinRtObjectArgDelegate {
            ...
            return JvmWinRtObjectArgDelegate(arena, instance)
        }
        ...
        private fun invoke(thisPointer: MemorySegment, arg: MemorySegment): Int {
            val state = states[thisPointer.address()] ?: return KnownHResults.E_POINTER.value
            return state.invoke(ComPtr(AbiIntPtr(arg.address()))).value
        }
