...
class JvmWinRtNoArgBooleanDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtNoArgBooleanDelegate::class.java,
                "queryInterface",
        ...
        fun create(iid: Guid, invoke: () -> Boolean): JvmWinRtNoArgBooleanDelegate {
            ...
            return JvmWinRtNoArgBooleanDelegate(arena, instance)
        }
        ...
        @JvmStatic
        private fun invoke(thisPointer: MemorySegment, result: MemorySegment): Int {
            val state = states[thisPointer.address()] ?: return KnownHResults.E_POINTER.value
            result.reinterpret(ValueLayout.JAVA_INT.byteSize().toLong()).set(ValueLayout.JAVA_INT, 0, if (state.invoke()) 1 else 0)
