...
class JvmWinRtBooleanArgDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtBooleanArgDelegate::class.java,
                "queryInterface",
        ...
        private val invokeStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtBooleanArgDelegate::class.java,
                "invoke",
                MethodType.methodType(Int::class.javaPrimitiveType, MemorySegment::class.java, Int::class.javaPrimitiveType),
            ),
            FunctionDescriptor.of(ValueLayout.JAVA_INT, ValueLayout.ADDRESS, ValueLayout.JAVA_INT),
            libraryArena,
        )

        fun create(iid: Guid, invoke: (Boolean) -> HResult): JvmWinRtBooleanArgDelegate {
            ...
            return JvmWinRtBooleanArgDelegate(arena, instance)
        }
        ...
        @JvmStatic
        private fun invoke(thisPointer: MemorySegment, arg: Int): Int {
            val state = states[thisPointer.address()] ?: return KnownHResults.E_POINTER.value
            return state.invoke(arg != 0).value
        }
