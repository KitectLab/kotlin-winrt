...
class JvmWinRtUInt32ArgDelegate private constructor(
    ...
    companion object {
        ...
        private val queryInterfaceStub = linker.upcallStub(
            lookup.findStatic(
                JvmWinRtUInt32ArgDelegate::class.java,
                "queryInterface",
        ...
        fun create(iid: Guid, invoke: (UInt) -> HResult): JvmWinRtUInt32ArgDelegate {
            ...
            return JvmWinRtUInt32ArgDelegate(arena, instance)
        }
        ...
        private fun invoke(thisPointer: MemorySegment, arg: Int): Int {
            val state = states[thisPointer.address()] ?: return KnownHResults.E_POINTER.value
            return state.invoke(arg.toUInt()).value
        }
