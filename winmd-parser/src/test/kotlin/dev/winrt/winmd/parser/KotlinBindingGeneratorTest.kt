...
class KotlinBindingGeneratorTest {
    ...
    fun generates_bindings_for_known_namespaces() {
        ...
        assertTrue(xamlBindings.contains("fun getLaunchCount(): UInt32 = UInt32(0u)"))
        assertTrue(xamlBindings.contains("val isVisible: WinRtBoolean"))
        assertTrue(xamlBindings.contains("val createdAt: DateTime"))
        assertTrue(xamlBindings.contains("val lifetime: TimeSpan"))
        assertTrue(xamlBindings.contains("val lastToken: EventRegistrationToken"))
        assertTrue(xamlBindings.contains("val stableId: GuidValue"))
        assertTrue(xamlBindings.contains("val optionalTitle: IReference<String>"))
