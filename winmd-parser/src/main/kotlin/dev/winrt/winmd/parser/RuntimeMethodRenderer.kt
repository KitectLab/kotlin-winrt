...
internal class RuntimeMethodRenderer(
    ...
    private fun runtimeMethodPlan(method: WinMdMethod, currentNamespace: String): RuntimeMethodPlan? {
        ...
        plannedChar16ReceiveArrayRuntimeMethod(method)?.let { return it }
        ...
        plannedUInt16PassArrayRuntimeMethod(method, currentNamespace)?.let { return it }
        plannedChar16PassArrayRuntimeMethod(method, currentNamespace)?.let { return it }
        plannedFloat32PassArrayRuntimeMethod(method, currentNamespace)?.let { return it }
        plannedFloat64PassArrayRuntimeMethod(method, currentNamespace)?.let { return it }
        ...
        plannedDateTimePassArrayRuntimeMethod(method, currentNamespace)?.let { return it }
        plannedTimeSpanPassArrayRuntimeMethod(method, currentNamespace)?.let { return it }
    ...
    private fun plannedUInt8ReceiveArrayRuntimeMethod(method: WinMdMethod): RuntimeMethodPlan? {
        if (!method.isUInt8ReceiveArrayReturnMethod()) {
            return null
        }
        return RuntimeMethodPlan(
    ...
    private fun plannedInt16ReceiveArrayRuntimeMethod(method: WinMdMethod): RuntimeMethodPlan? {
        if (!method.isInt16ReceiveArrayReturnMethod()) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method -> PlannedStatement("error(%S)", arrayOf<Any>("Null runtime object pointer: ${method.name}")) },
    ...
    private fun plannedUInt16ReceiveArrayRuntimeMethod(method: WinMdMethod): RuntimeMethodPlan? {
        if (!method.isUInt16ReceiveArrayReturnMethod()) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method -> PlannedStatement("error(%S)", arrayOf<Any>("Null runtime object pointer: ${method.name}")) },
    ...
    private fun plannedChar16ReceiveArrayRuntimeMethod(method: WinMdMethod): RuntimeMethodPlan? {
        if (!method.isChar16ReceiveArrayReturnMethod()) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method -> PlannedStatement("error(%S)", arrayOf<Any>("Null runtime object pointer: ${method.name}")) },
    ...
    private fun plannedBooleanReceiveArrayRuntimeMethod(method: WinMdMethod): RuntimeMethodPlan? {
        if (!method.isBooleanReceiveArrayReturnMethod()) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method -> PlannedStatement("error(%S)", arrayOf<Any>("Null runtime object pointer: ${method.name}")) },
    ...
    private fun plannedInt64ReceiveArrayRuntimeMethod(method: WinMdMethod): RuntimeMethodPlan? {
    ...
    private fun plannedStringReceiveArrayRuntimeMethod(method: WinMdMethod): RuntimeMethodPlan? {
        if (!method.isStringReceiveArrayReturnMethod()) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedStringPassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isStringPassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedDateTimePassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isDateTimePassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedUInt32PassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isUInt32PassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedBooleanPassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isBooleanPassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
            ...
            statementArgs = { method, _, parameterBindings ->
                ...
                arrayOf(
                    if (method.returnType == "Unit") runtimeVarargAbiCall("invokeUnitMethodWithArgs", method.vtableIndex!!, abiArguments)
                    else runtimeObjectReturnCode(method = method, currentNamespace = currentNamespace, abiCall = runtimeVarargAbiCall("invokeObjectMethodWithArgs", method.vtableIndex!!, abiArguments)),
                )
            },
        )
    }

    private fun plannedUInt8PassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isUInt8PassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedInt16PassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isInt16PassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedUInt16PassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isUInt16PassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedChar16PassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isChar16PassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedFloat32PassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isFloat32PassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedFloat64PassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isFloat64PassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedInt64PassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isInt64PassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedUInt64PassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isUInt64PassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun plannedTimeSpanPassArrayRuntimeMethod(
        method: WinMdMethod,
        currentNamespace: String,
    ): RuntimeMethodPlan? {
        if (!method.isTimeSpanPassArrayMethod { typeName -> supportsRuntimeObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
        return RuntimeMethodPlan(
            nullPointerReturn = { method ->
    ...
    private fun runtimeMethodPlanForKey(signatureKey: MethodSignatureKey): RuntimeMethodPlan? {
        ...
        return when (signatureKey) {
            ...
            MethodSignatureKey(MethodReturnKind.INT32, MethodSignatureShape.STRING) -> RuntimeMethodPlan(
                nullPointerReturn = { method -> int32NullReturn(method.returnType) },
                returnStatement = "return %L",
                statementArgs = { method, _, parameterBindings ->
                    arrayOf(
                        int32ReturnCode(
                            method.returnType,
                            AbiCallCatalog.int32MethodWithString(method.vtableIndex!!, parameterBindings.single().name),
                        ),
                    )
                },
            )
                    ...
                    arrayOf(
                        int32ReturnCode(
                            ...
                            AbiCallCatalog.int32MethodWithBoolean(
                                method.vtableIndex!!,
                                int64AbiArgumentExpression(argumentName, parameterBindings.single().type),
                            ),
                        ),
                    )
                },
            ...
            MethodSignatureKey(MethodReturnKind.INT32, MethodSignatureShape.EMPTY) -> RuntimeMethodPlan(
                ...
                statementArgs = { method, _, _ ->
                    arrayOf(
                        int32ReturnCode(
                            method.returnType,
                            CodeBlock.of("%T.invokeInt32Method(pointer, %L).getOrThrow()", PoetSymbols.platformComInteropClass, method.vtableIndex!!),
                        ),
                    )
                },
            )
            ...
            MethodSignatureKey(MethodReturnKind.UNIT, MethodSignatureShape.INT32) -> RuntimeMethodPlan(
                ...
                statementArgs = { method, _, parameterBindings ->
                    arrayOf(
                        AbiCallCatalog.unitMethodWithInt32(
                            method.vtableIndex!!,
                            int64AbiArgumentExpression(parameterBindings.single().name, parameterBindings.single().type),
                        ),
                    )
