...
internal class RuntimeCompanionRenderer(
    ...
    private fun canForwardSupportedArrayMethod(method: WinMdMethod, currentNamespace: String): Boolean {
        return method.isInt32PassArrayMethod { typeName ->
            ...
            (
                method.isStringPassArrayMethod { typeName ->
                    !typeRegistry.isStructType(typeName, currentNamespace) && supportsProjectedObjectTypeName(typeName)
                } &&
                    method.parameters
            ...
            (
                method.isUInt8PassArrayMethod { typeName ->
                    !typeRegistry.isStructType(typeName, currentNamespace) && supportsProjectedObjectTypeName(typeName)
                } &&
                    method.parameters
            ...
            (
                method.isInt16PassArrayMethod { typeName ->
                    !typeRegistry.isStructType(typeName, currentNamespace) && supportsProjectedObjectTypeName(typeName)
                } &&
                    method.parameters
            ...
            (
                method.isUInt16PassArrayMethod { typeName ->
                    !typeRegistry.isStructType(typeName, currentNamespace) && supportsProjectedObjectTypeName(typeName)
                } &&
                    method.parameters
            ...
            (
                method.isChar16PassArrayMethod { typeName ->
                    !typeRegistry.isStructType(typeName, currentNamespace) && supportsProjectedObjectTypeName(typeName)
                } &&
                    method.parameters
            ...
            (
                method.isFloat32PassArrayMethod { typeName ->
                    !typeRegistry.isStructType(typeName, currentNamespace) && supportsProjectedObjectTypeName(typeName)
                } &&
                    method.parameters
            ...
            (
                method.isFloat64PassArrayMethod { typeName ->
                    !typeRegistry.isStructType(typeName, currentNamespace) && supportsProjectedObjectTypeName(typeName)
                } &&
                    method.parameters
            ...
            (
                method.isInt64PassArrayMethod { typeName ->
                    !typeRegistry.isStructType(typeName, currentNamespace) && supportsProjectedObjectTypeName(typeName)
                } &&
                    method.parameters
            ...
            (
                method.isUInt64PassArrayMethod { typeName ->
                    !typeRegistry.isStructType(typeName, currentNamespace) && supportsProjectedObjectTypeName(typeName)
                } &&
                    method.parameters
            ...
            (
                method.isUInt8ReceiveArrayReturnMethod() &&
                    method.parameters.all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            (
                method.isInt16ReceiveArrayReturnMethod() &&
                    method.parameters.all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            (
                method.isUInt16ReceiveArrayReturnMethod() &&
                    method.parameters.all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            (
            ...
            (
                method.isChar16ReceiveArrayReturnMethod() &&
                    method.parameters.all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            (
                method.isBooleanReceiveArrayReturnMethod() &&
                    method.parameters.all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            (
                method.isFloat32ReceiveArrayReturnMethod() &&
                    method.parameters.all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            (
                method.isFloat64ReceiveArrayReturnMethod() &&
                    method.parameters.all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            (
            ...
            (
                method.runtimeClassReceiveArrayElementType(currentNamespace, typeRegistry) != null &&
                    method.parameters
                        .filterNot { parameter ->
                            parameter.isRuntimeClassPassArrayParameter(
                                currentNamespace,
                                typeRegistry,
                                method.runtimeClassReceiveArrayElementType(currentNamespace, typeRegistry),
                            )
                        }
                        .all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            ...
            (
                method.isGuidReceiveArrayReturnMethod() &&
                    method.parameters.all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            (
                method.isInt64ReceiveArrayReturnMethod() &&
                    method.parameters.all { parameter -> supportsForwardableCompanionArrayParameter(parameter.type, currentNamespace) }
                ) ||
            (
