...
internal class InterfaceTypeRenderer(
    ...
    private fun plannedInterfaceMethod(
        ...
        plannedChar16ReceiveArrayInterfaceMethod(method)?.let { return it }
        ...
        plannedGuidPassArrayInterfaceMethod(method, currentNamespace, genericParameters)?.let { return it }
        plannedStructPassArrayInterfaceMethod(method, currentNamespace, genericParameters)?.let { return it }
        plannedBooleanPassArrayInterfaceMethod(method, currentNamespace, genericParameters)?.let { return it }
        plannedUInt8PassArrayInterfaceMethod(method, currentNamespace, genericParameters)?.let { return it }
        plannedInt16PassArrayInterfaceMethod(method, currentNamespace, genericParameters)?.let { return it }
        plannedUInt16PassArrayInterfaceMethod(method, currentNamespace, genericParameters)?.let { return it }
        plannedChar16PassArrayInterfaceMethod(method, currentNamespace, genericParameters)?.let { return it }
        ...
        plannedDateTimePassArrayInterfaceMethod(method, currentNamespace, genericParameters)?.let { return it }
        plannedTimeSpanPassArrayInterfaceMethod(method, currentNamespace, genericParameters)?.let { return it }
    ...
    private fun plannedUInt8ReceiveArrayInterfaceMethod(method: WinMdMethod): PlannedInterfaceMethod? {
    ...
    private fun plannedInt16ReceiveArrayInterfaceMethod(method: WinMdMethod): PlannedInterfaceMethod? {
    ...
    private fun plannedUInt16ReceiveArrayInterfaceMethod(method: WinMdMethod): PlannedInterfaceMethod? {
    ...
    private fun plannedChar16ReceiveArrayInterfaceMethod(method: WinMdMethod): PlannedInterfaceMethod? {
    ...
    private fun plannedBooleanReceiveArrayInterfaceMethod(method: WinMdMethod): PlannedInterfaceMethod? {
    ...
    private fun plannedGuidPassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isGuidPassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedObjectReceiveArrayInterfaceMethod(method: WinMdMethod): PlannedInterfaceMethod? {
    ...
    private fun plannedUInt32ReceiveArrayInterfaceMethod(method: WinMdMethod): PlannedInterfaceMethod? {
    ...
    private fun plannedUInt64ReceiveArrayInterfaceMethod(method: WinMdMethod): PlannedInterfaceMethod? {
    ...
    private fun plannedStringReceiveArrayInterfaceMethod(method: WinMdMethod): PlannedInterfaceMethod? {
    ...
    private fun plannedStringPassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isStringPassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedDateTimePassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isDateTimePassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedUInt32PassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isUInt32PassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedBooleanPassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isBooleanPassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedUInt8PassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isUInt8PassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedInt16PassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isInt16PassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedUInt16PassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isUInt16PassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedChar16PassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isChar16PassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedInt64PassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isInt64PassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedUInt64PassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isUInt64PassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
    ...
    private fun plannedTimeSpanPassArrayInterfaceMethod(
        method: WinMdMethod,
        currentNamespace: String,
        genericParameters: Set<String>,
    ): PlannedInterfaceMethod? {
        if (!method.isTimeSpanPassArrayMethod { typeName -> supportsInterfaceObjectReturnType(typeName, currentNamespace) }) {
            return null
        }
