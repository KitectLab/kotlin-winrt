...
class JsonArrayRealMetadataProbeTest {
    ...
    private fun classifyObjectAt(pointer: dev.winrt.kom.ComPtr, slot: UInt): String {
        val result = PlatformComInterop.invokeObjectMethodWithUInt32Arg(pointer, slot.toInt(), 0u)
        if (result.isFailure) {
